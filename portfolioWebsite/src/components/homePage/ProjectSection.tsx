...
export default function ProjectSection ({ roadmapWidth, roadmapYProgress } : projectSectionProps) {
    ...
    const projectOpacity = useTransform(roadmapYProgress, roadmapWidth < 798 ? [0.2, 0.3] : [0.3, 0.38], [0, 1])
    const projectX = useTransform(roadmapYProgress, roadmapWidth < 798 ? [0.2, 0.3] :[0.3, 0.38], [300, 0])
