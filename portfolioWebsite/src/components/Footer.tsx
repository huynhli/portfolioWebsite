...
export default function Footer() {
    ...
    return (
        <div className='flex justify-between h-20 bg-purple-300'>
            
            {/* Name */}
            <div className='self-center px-8'>
                <button className="aboveline-hover bg-purple-300 px-2 py-1 duration-400 rounded-b-lg text-white hover:bg-white hover:text-black">
                    © 2025 Liam Huynh
                </button>
            </div>
            ...
            {/* Social links */}
            <div className="self-center px-8">
                <div className="flex justify-evenly aboveline-hover bg-purple-300 px-2 py-1 duration-400 rounded-b-lg hover:bg-white text-white group">
