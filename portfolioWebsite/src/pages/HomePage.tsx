...
export default function HomePage() {
    ...
    const bottomWavesY = useTransform(scrollYProgress, [0.5, 0.6], [0, 700])
        ...
        <div className='relative flex flex-col'>
            ...
            <section className="relative flex flex-col h-200 justify-center items-center">
                ...
                <motion.div
                    ...
                    className="flex flex-col z-50 w-[25%] min-w-90 max-w-100 h-50 px-5 bg-zinc-900 border-1 border-white rounded-lg justify-center"
                >
            ...
            <motion.section className="absolute w-full top-100 z-10 scale-y-50"
            ...
            <motion.section className="relative flex-col top-[-400px] w-full z-10 scale-y-50"
                // style = start values, animate = end values, transition for type 
                style={{ y: bottomWavesSpring }}
