...
export default function HomePage() {
    ...
    return (
        <div className='relative flex flex-col'>
            ...
            {/* contact info */}
            <div className="text-white h-100 z-100 flex flex-col justify-center items-center text-5xl 2xl:w-auto mx-[10%] pt-[6%] mb-[3%]">
                Find me:
                <div className="mt-6 xl:mt-24 mb-2 text-3xl xl:text-4xl 2xl:text-5xl flex flex-col justify-center items-center xl:flex-row xl:justify-between w-full italic">
